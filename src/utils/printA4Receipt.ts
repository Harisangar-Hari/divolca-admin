...
<head>
  ...
  <style>
    * { 
    ...
    .payment-mode .value.cash {
      color: #0B6E4F;
    }
    .payment-mode .value.card {
      color: #2563EB;
    }
    .payment-mode .value.credit {
      color: #7C3AED;
    }
    ...
    .totals-table .sub-discount-row td {
      color: #000;
      font-size: 8pt;
      padding-left: 20px;
    }
...
<div class="invoice">
  ...
  <div class="totals-section no-page-break">
    <table class="totals-table">
      ...
      ${hasInvoiceDiscount ? `
      <tr class="sub-discount-row">
        <td class="label">Invoice Discount (${invoiceDiscountPercent}%)</td>
        <td class="value">(${fmt(invoiceDiscountAmount)})</td>
      </tr>
      ` : ''}
      ${(hasItemDiscount || hasInvoiceDiscount) ? `
      <tr class="discount-row" style="border-top: 1px dashed #000; padding-top: 2px;">
